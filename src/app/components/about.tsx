  ...
  return (
    <Box sx={{ marginTop: "50px" }}>
      <Typography variant="body1" sx={{ marginTop: "20px" }}>
        ...
        odyssey featuring his experiences alongside SoftBank&apos;s iconic
        founder, Masayoshi Son, a visionary maverick who wants to be remembered
        as “the crazy guy who bet on the future” and whose mission is “happiness
        for everyone.” Sama takes the reader on a wild journey as he consorts
        with A-list CEOs and heads of state, and negotiates mega-deals on a
        Gulfstream jet, Son&apos;s sanctuary with its exquisite Japanese garden,
        and a waterside restaurant in the Turkish Riviera—all while contending
        with a mysterious dark-arts smear campaign that takes a toll on his
        private life.
        <br />
        <br />
